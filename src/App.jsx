...
function App(){
  ...
  useEffect(()=>{if(mode==='menu')return; const i=setInterval(()=>{setCivs(p=>p.map(tickCiv)); setEnergy(e=>Math.min(200,e+5));},speed); return ()=>clearInterval(i);},[speed,mode]);
